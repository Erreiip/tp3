public class Portefeuille {
     ...
     * du portefeuille actuel doit être supérieur monnaieou égal à celui indiqué.
     * @param destination 
     * @param montantJetons
    ...
    public boolean transfertDevise (Portefeuille destination, double montantJetons){
        ...
        if (this.montant-montantJetons >= 0 && this.monnaie.getNom().equals(destination.monnaie.getNom())) {
